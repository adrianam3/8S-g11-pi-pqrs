...
class Atenciones
{
     ...
     * Retorna ['idCliente' => int, 'idAtencion' => int] o string con mensaje de error.
     */
    public function upsertClienteYAtencion(
        ...
        try {
            ...
            // Tipos (14 params): 'sssssssissssis'
            $stmt->bind_param(
                'sssssssissssis',
                $idClienteErp,
                $cedula,
            ...
            // Obtener el SELECT final del SP: idCliente, idAtencion
            $out = null;
            ...
            if (is_array($out) && isset($out['idCliente']) && isset($out['idAtencion'])) {
                return ['idCliente' => (int)$out['idCliente'], 'idAtencion' => (int)$out['idAtencion']];
            }
    ...
    /**
     * NUEVO: Llamada al procedimiento sp_programar_despues_de_upsert_auto
