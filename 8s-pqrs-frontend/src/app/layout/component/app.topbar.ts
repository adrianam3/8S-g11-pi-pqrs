    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <!-- <a class="layout-topbar-logo" routerLink="/">
                ...
                <img src="assets/images/logo.png" alt="Logo" class="mb-8 mx-auto block w-12 sm:w-14 md:w-16 lg:w-20 xl:w-24" />
            ...
            <a href="/" class="flex items-center space-x-4">
                <img src="assets/images/logo.png" alt="Logo"
                    class="h-auto max-h-10 w-auto max-w-[150px]" />
                <span class="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold text-gray-800">
                    GESTIÓN PQRS
                </span>
            </a>
        ...
        <div class="relative">
            <button pButton type="button" class="p-button-text layout-topbar-action" (click)="toggleUserMenu()">
                <i class="pi pi-user text-xl"></i>
            </button>

            <!-- Menú desplegable del usuario -->
            <div *ngIf="showUserMenu"
                class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-lg z-50"
                style="top: 100%;">
                <div class="px-4 py-2 text-gray-800 border-b font-medium">
                    {{ usuario }}
                </div>
                <button pButton type="button"
                        class="p-button-text w-full text-left px-4 py-2 text-red-600 hover:bg-gray-100"
                        (click)="confirmLogout()">
